...
public class RejectedFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        filter = view.findViewById(R.id.filterReject);
...
//                if(snapshot.exists()){
//                    List<SchemesStatusData> schemesStatusData = new ArrayList<>();
...
//                                            schemesStatusData.add(data);
////                                            Log.d("Check",applicationId);
//                                        }
//                                    }
//                                    if (schemesStatusData.size()==0){
//                                        if (getContext()!=null) {
//                                            Toast.makeText(getContext(), "No Rejected application Found!!!", Toast.LENGTH_SHORT).show();
//                                        }
//                                    }
//                                    GridLayoutManager gridLayoutManager = new GridLayoutManager(getContext(), 1);
//                                    recyclerView.setLayoutManager(gridLayoutManager);
//
//                                    HistoryAdapter historyAdapter = new HistoryAdapter(getContext(),schemesStatusData);
...
//
//                        FirebaseDatabase.getInstance().getReference("USERS").child(userName).child("Schemes").child(selectedYear).addValueEventListener(new ValueEventListener() {
//                            @Override
//                            public void onDataChange(@NonNull DataSnapshot snapshot) {
//                                if(snapshot.exists()) {
//                                    List<SchemesStatusData> schemesStatusData = new ArrayList<>();
...
//                                    if (schemesStatusData.size()==0){
//                                        if (getContext()!=null) {
//                                            Toast.makeText(getContext(), "No Rejected application Found in Year " + selectedYear + " !!!", Toast.LENGTH_SHORT).show();
//                                        }
//                                    }
//                                    GridLayoutManager gridLayoutManager = new GridLayoutManager(getContext(), 1);
//                                    recyclerView.setLayoutManager(gridLayoutManager);
